...
export const aboutContent: AboutContent = {
  ...
  bio: [
    ...
    "Design things feels a lot like that to me. Most ideas aren’t the right idea. You explore, pull on different threads, change your mind, and sometimes go too far before knowing when to pull something back. Eventually you find a direction that keeps going. Then it becomes about staying with it until everything feels just right. Reaching a place where you’re proud of the work and pushed the bar a little higher. When it reaches someone else, I want them to feel the care and intention that went into making it.",
