...
export const aboutContent: AboutContent = {
  ...
  bio: [
    "I’ve always loved the process of getting good at something. It started with skateboarding, then surfing, freestyle skiing, and snowboarding. Before becoming a designer, I even spent a couple years immersed in cooking at a Michelin-starred kitchen in New York City. The throughline of these different pursuits is what I love... try something, get it wrong, try again, slowly get better, and eventually bring your own style to it.",
    ...
    "As much as I love the craft itself, I’ve learned that I really love building things with other people. Throwing ideas around, challenging each other, and shaping something none of us would have arrived at alone. When I think about the work I’m most proud of, I think just as much about the people I built with. That matters to me, and I try to be the kind of teammate people genuinely enjoy working with.",
  ],
  social: [],
  contact: {
    title: "Get in touch",
