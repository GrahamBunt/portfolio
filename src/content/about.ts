...
export const aboutContent: AboutContent = {
  ...
  bio: [
    "I’ve always been drawn to things that take practice. As a kid, it started with skateboarding, then surfing and freestyle skiing, and eventually cooking in a Michelin-starred kitchen in New York. All different, but the part I love is the same—try something, get it wrong, try again, slowly get better, and eventually bring your own style to it.",
