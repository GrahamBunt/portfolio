...
export const aboutContent: AboutContent = {
  ...
  bio: [
    "I’ve always loved the process of getting good at something. It started with skateboarding, then surfing, and then freestyle skiing and snowboarding. Before becoming a designer, I spent a couple years immersed in cooking at a Michelin-starred restaurant in NYC. The throughline of these different pursuits is what I love—try something, get it wrong, try again, slowly get better, and eventually bring your own style to it.",
